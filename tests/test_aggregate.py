...
from aggregate import build_b2c_sql, build_compat_view_sql, build_total_view_sql
...
def test_compat_view_total_has_version_and_b2b_cols():
    sql = build_compat_view_sql(
        src_fqn="proj.Total.user_tracking_total",
        view_fqn="proj.Total.user_tracking_total_compat",
